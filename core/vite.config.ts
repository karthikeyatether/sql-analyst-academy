    ...
    rollupOptions: {
      ...
      output: {
        manualChunks(id) {
          ...
          if (id.includes("src/data/problemsBasic")) return "problems-basic";
          if (id.includes("src/data/problemsIntermediate")) return "problems-intermediate";
          if (id.includes("src/data/problemsAdvanced")) return "problems-advanced";
