...
export const missionCapstones: MissionCapstone[] = [
  {
    ...
    estimatedMinutes: 25,
    description:
      "Executive leadership noticed a drop in 30-day active diners. Your mission is to write SQL queries to audit order frequency, identify churned VIP accounts, and build an executive summary.",
    steps: [
      {
        stepNumber: 1,
