...
export default function SqlJoinVennDiagram() {
  ...
  const isCrescentAActive =
    joinType === "LEFT" || joinType === "FULL" || joinType === "LEFT_ANTI";
  const isCrescentBActive =
    joinType === "RIGHT" || joinType === "FULL" || joinType === "RIGHT_ANTI";
  ...
  return (
    <div className="join-diagram-wrap">
      ...
      >
        ...
        <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
          {(
            ...
            ] as { value: JoinType; label: string }[]
          ).map((item) => (
            <button
              key={item.value}
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => {
              ...
              if (e.target.value === rightTableKey) {
                setRightTableKey(
                  e.target.value === "customers" ? "orders" : "customers",
                );
              }
            }}
            style={{
          ...
          >
            <option value="customers">
              customers (Sales key: customer_id)
            </option>
          ...
          <select
            ...
            onChange={(e) => {
              ...
              if (e.target.value === leftTableKey) {
                setLeftTableKey(
                  e.target.value === "orders" ? "customers" : "orders",
                );
              }
            }}
            style={{
      ...
      <div className="venn-svg-container">
        <svg viewBox="0 0 400 200" className="venn-svg-element">
          ...
          <path
            ...
            style={{
              ...
              filter:
                hoveredRegion === "left"
                  ? "brightness(1.3) drop-shadow(0 0 10px rgba(56,217,255,0.4))"
                  : "none",
            }}
            tabIndex={0}
            role="button"
          ...
          <path
            ...
            style={{
              ...
              filter:
                hoveredRegion === "right"
                  ? "brightness(1.3) drop-shadow(0 0 10px rgba(48,230,149,0.4))"
                  : "none",
            }}
            tabIndex={0}
            role="button"
          ...
          <path
            ...
            style={{
              ...
              transition: "all 0.4s cubic-bezier(0.16, 1, 0.3, 1)",
              filter:
                hoveredRegion === "intersection"
                  ? "brightness(1.3) drop-shadow(0 0 10px rgba(155,124,255,0.4))"
                  : "none",
            }}
            tabIndex={0}
            role="button"
        ...
        <div
          style={{
            ...
            color: "var(--muted)",
            textAlign: "center",
            fontStyle: hoveredRegion ? "normal" : "italic",
          }}
        >
          {hoveredRegion
            ? regionDescriptions[hoveredRegion]
            : "Hover over segments of the diagram to inspect join behavior."}
        </div>
      </div>
      ...
      <div>
        ...
        >
          Resulting Record Stream ({joinedData.filter((d) => d.included).length}{" "}
          rows)
        </span>
        <div
          className="table-wrap"
          style={{ marginTop: "8px", maxHeight: "200px", overflowY: "auto" }}
        >
                  ...
                  >
                    ...
                    {leftTable.columns.map((c) => (
                      <td
                        key={c}
                        style={{
                          color: row.leftRow ? "var(--text)" : "var(--rose)",
                          fontWeight: row.leftRow ? "normal" : "bold",
                        }}
                      >
                    ...
                    {rightTable.columns.map((c) => (
                      <td
                        key={c}
                        style={{
                          color: row.rightRow ? "var(--text)" : "var(--rose)",
                          fontWeight: row.rightRow ? "normal" : "bold",
                        }}
                      >
