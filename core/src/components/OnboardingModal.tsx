...
export default function OnboardingModal({
  ...
  useEffect(() => {
    const primaryBtn = modalRef.current?.querySelector(
      ".onboard-nav-btn-next, .onboard-start-btn",
    );
  ...
  const steps = [
    ...
    },
    {
      ...
      description:
        "Take a step-by-step path from basic SELECT statements up to advanced Common Table Expressions (CTEs), Window Functions, and query optimization.",
    ...
    },
    {
      ...
      description:
        "Use autocomplete code blocks, view live database schemas, read column distributions with our ERD explorer, and get real-time lint warnings as you type.",
    ...
    },
    {
      ...
      description:
        "Simulate timed analytics interviews modeled after tests at Cred, Swiggy, Paytm, and Myntra. Learn to write performant queries under pressure.",
    ...
    },
    {
      ...
      description:
        "All learning data is stored locally in your browser. Use the Backup & Restore JSON controls inside settings to save or restore your progress anytime.",
