...
import { Menu, X, Search, Command, Moon, Sun, Zap, Palette, Code2, Flame, Check } from "lucide-react";
...
export function TopBar({ props }: { props: {
  ...
  const {
    sidebarOpen, setSidebarOpen, searchRef, searchTerm, setSearchTerm,
    filteredSearch, handleSearchPick, theme, themeMenuOpen, setThemeMenuOpen,
    cycleTheme, THEME_OPTIONS, setTheme, readiness
  } = props;
