...
export const tableSchemas: TableSchema[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "payment_date", type: "DATE", note: "Settlement date" },
      {
        name: "payment_mode",
        type: "TEXT",
        note: "UPI, card, wallet, netbanking",
      },
      {
        name: "payment_status",
        type: "TEXT",
        note: "Success, failed, refunded",
      },
  ...
  },
  {
    ...
    domain: "Retention",
    description:
      "Subscription lifecycle data for churn and retention analysis.",
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "office_city", type: "TEXT", note: "Main office location" },
      {
        name: "budget_lakhs",
        type: "DECIMAL",
        note: "Annual budget in INR lakhs",
      },
    ],
  },
  {
    ...
    domain: "Employees",
    description:
      "Employee facts for workforce, compensation, and manager analysis.",
  ...
  },
  {
    ...
    description:
      "Restaurant delivery orders with ratings and delivery durations.",
...
export const seedTables: SeedTable[] = [
    ...
    rows: [
      {
        ...
        segment: "Premium",
        metadata:
          '{"device": "Mobile", "app_version": "v4.2.1", "referred_by": 3}',
      },
      {
        customer_id: 2,
        ...
        city: "Bengaluru",
        region: "South",
        signup_date: "2023-02-05",
        segment: "Student",
        metadata:
          '{"device": "Web", "app_version": "v1.0.8", "referred_by": null}',
      },
      {
        customer_id: 3,
        ...
        city: "Delhi",
        region: "North",
        signup_date: "2023-02-21",
        segment: "Value",
        metadata:
          '{"device": "Mobile", "app_version": "v4.2.0", "referred_by": null}',
      },
      {
        customer_id: 4,
        ...
        segment: "Premium",
        metadata:
          '{"device": "Mobile", "app_version": "v4.2.1", "referred_by": 1}',
      },
      {
        customer_id: 5,
        ...
        city: "Ahmedabad",
        region: null,
        signup_date: "2023-03-29",
        segment: "Value",
        metadata:
          '{"device": "Web", "app_version": "v1.0.9", "referred_by": null}',
      },
      {
        customer_id: 6,
        ...
        segment: "Premium",
        metadata:
          '{"device": "Mobile", "app_version": "v4.2.2", "referred_by": null}',
      },
      {
        customer_id: 7,
        full_name: "Sara Khan",
        city: "Hyderabad",
        region: "South",
        signup_date: "2023-05-06",
        segment: "Student",
        metadata:
          '{"device": "Web", "app_version": "v1.0.8", "referred_by": 2}',
      },
      {
        customer_id: 8,
        ...
        city: "Chennai",
        region: "South",
        signup_date: "2023-06-17",
        segment: "Value",
        metadata:
          '{"device": "Mobile", "app_version": "v4.1.9", "referred_by": null}',
      },
      {
        customer_id: 9,
        ...
        city: "Jaipur",
        region: "North",
        signup_date: "2023-07-09",
        segment: "Premium",
        metadata:
          '{"device": "Web", "app_version": "v1.0.9", "referred_by": 4}',
      },
      {
        customer_id: 10,
        full_name: "Arjun Das",
      ...
      },
      {
        ...
        city: "Gurugram",
        region: "North",
        signup_date: "2023-08-16",
        segment: "Premium",
        metadata:
          '{"device": "Mobile", "app_version": "v4.2.3", "referred_by": 9}',
      },
      {
        customer_id: 12,
        ...
        segment: "Student",
        metadata:
          '{"device": "Web", "app_version": "v1.0.7", "referred_by": null}',
      },
      {
        customer_id: 13,
        full_name: "Aarav Mehta",
  ...
  },
  {
    ...
    rows: [
      {
        product_id: 201,
        product_name: "Galaxy Wireless Mouse",
      ...
      {
        product_id: 205,
        product_name: "Steel Water Bottle",
        category: "Home",
        brand: "DailyNest",
        cost_price: 280,
        list_price: 799,
    ...
    rows: [
      {
        ...
        department_id: 10,
        manager_id: null,
        hire_date: "2020-04-12",
        salary_lpa: 30,
        role: "Analytics Manager",
      },
      {
        employee_id: 702,
        employee_name: "Rahul Bansal",
        department_id: 10,
        manager_id: 701,
      ...
      },
      {
        ...
        department_id: 20,
        manager_id: 704,
        hire_date: "2022-08-04",
        salary_lpa: 9.5,
        role: "Account Executive",
      },
      {
        employee_id: 706,
        employee_name: "Manav Suri",
        department_id: 30,
        manager_id: null,
      ...
      },
      {
        ...
        department_id: 40,
        manager_id: null,
        hire_date: "2020-09-27",
        salary_lpa: 21,
        role: "Finance Manager",
      },
      {
        employee_id: 709,
        employee_name: "Neel Shah",
        department_id: 50,
        manager_id: null,
    ...
    rows: [
      {
        ...
        city: "Delhi",
        order_date: "2024-05-01 12:30:00",
        gross_value: 740,
        delivery_minutes: 34,
        rating: null,
      },
      {
        food_order_id: 3002,
        restaurant: "Dosa Central",
        city: "Bengaluru",
        order_date: "2024-05-01 18:45:00",
        gross_value: 420,
        delivery_minutes: 28,
        rating: 4.4,
      },
      {
        ...
        city: "Hyderabad",
        order_date: "2024-05-02 09:15:00",
        gross_value: 890,
        delivery_minutes: 42,
        rating: 4.7,
      },
      {
        food_order_id: 3004,
        restaurant: "Cafe Mandala",
        city: "Pune",
        order_date: "2024-05-02 21:00:00",
        gross_value: 510,
        delivery_minutes: 31,
        rating: 4.2,
      },
      {
        ...
        city: "Mumbai",
        order_date: "2024-05-03 14:10:00",
        gross_value: 680,
        delivery_minutes: 39,
        rating: 4.7,
      },
      {
        ...
        city: "Gurugram",
        order_date: "2024-05-03 20:00:00",
        gross_value: 1120,
        delivery_minutes: 48,
        rating: 4.1,
      },
      {
        ...
        city: "Kochi",
        order_date: "2024-05-04 11:20:00",
        gross_value: 760,
        delivery_minutes: 36,
        rating: 4.8,
      },
      {
        food_order_id: 3008,
        restaurant: "Noodle Yard",
        city: "Chennai",
        order_date: "2024-05-04 19:30:00",
        gross_value: 620,
        delivery_minutes: 29,
        rating: 4.3,
      },
