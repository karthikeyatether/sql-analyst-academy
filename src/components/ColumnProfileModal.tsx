...
export default function ColumnProfileModal({
  profile,
  onClose,
}: ColumnProfileModalProps) {
  const {
    table: tableName,
    column: columnName,
    total,
      ...
      >
        <div className="custom-modal-header">
          <h2 id="col-profile-title">
            <BarChart3 size={18} />
            <span>
              Column Profiler: {tableName}.{columnName}
            </span>
          </h2>
          <button
            ...
            <div className="profile-grid-container">
              ...
              <div className="profile-stat-box">
                ...
                <strong
                  style={{
                    fontSize: "16px",
                    color: nulls > 0 ? "var(--amber)" : "var(--emerald)",
                  }}
                >
                  {nulls}
                </strong>
              ...
              {avg !== undefined && avg !== null && (
                <div className="profile-stat-box">
                  ...
                  <strong style={{ fontSize: "16px", color: "var(--text)" }}>
                    {typeof avg === "number" ? avg.toFixed(2) : String(avg)}
                  </strong>
                </div>
              )}
            </div>
